class OBSWebSocket {
  ...
  handleFilterListResponse(responseData) {
    ...
    if (blurFilter) {
      ...
      console.log(`Found akaiho filter in source: ${sourceName}`)
    }
  ...
  checkSearchComplete() {
    setTimeout(() => {
      console.log(`Search complete. Found ${this.foundFilters.size} akaiho filters`)
