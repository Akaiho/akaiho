...
const siteOrigin = import.meta.env.VITE_SITE_ORIGIN || 'https://akaiho.github.io'
const basePath = normalizeBasePath(import.meta.env.VITE_BASE_URL || '/akaiho')
const canonicalUrl = `${siteOrigin}${basePath || ''}/`
const homeTitle = 'Akaiho - поиск фильмов и сериалов онлайн бесплатно'
const homeDescription =
  'Akaiho - онлайн-поиск фильмов и сериалов с быстрым переходом к просмотру, рейтингами, подборками, историей просмотров и удобной навигацией.'
...
useHead({
  ...
  meta: [
    ...
    { property: 'og:title', content: 'Akaiho - поиск фильмов и сериалов онлайн' },
    { property: 'og:description', content: homeDescription },
    { property: 'og:url', content: canonicalUrl },
    { property: 'og:locale', content: 'ru_RU' },
    { name: 'twitter:card', content: 'summary' },
    { name: 'twitter:title', content: 'Akaiho - поиск фильмов и сериалов онлайн' },
