...
describe('generate-seo-assets', () => {
  ...
  it('disallows auth callback routes in robots.txt', () => {
    const robots = createRobotsTxt({
      siteOrigin: 'https://akaiho.github.io',
      basePath: '/akaiho'
    })

    expect(robots).toContain('Disallow: /auth-success')
    expect(robots).toContain('Disallow: /akaiho/auth-success')
    expect(robots).toContain('Sitemap: https://akaiho.github.io/akaiho/sitemap.xml')
  })
})
